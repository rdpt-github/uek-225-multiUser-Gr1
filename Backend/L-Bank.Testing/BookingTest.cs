...
namespace TestProject1
{
    public class BookingTest
    {
        ...
        public async Task Post_BookingSuccessful_ReturnsOk()
        {
            ...
            _bookingRepositoryMock.Setup(repo => repo.Book(booking.SourceId, booking.DestinationId, booking.Amount)).Returns(true);
        ...
        public async Task Post_BookingConflict_ReturnsConflict()
        {
            // Arrange
            var booking = new Booking { SourceId = 1, DestinationId = 2, Amount = 100 };
            _bookingRepositoryMock.Setup(repo => repo.Book(booking.SourceId, booking.DestinationId, booking.Amount)).Returns(false);
